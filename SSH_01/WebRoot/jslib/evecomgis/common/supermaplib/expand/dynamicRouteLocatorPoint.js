(function () {
    ...
    var feature;
    function dowork() {
        $("#func").append($("<div style='margin-top:21px;'><span style='font-size: 1.2em;'>指定里程点：</span><input type='number' style='width:50px' id='locateMeasure' value='10'></div>"));
        var createRouteObj = '查询路由对象', routeLocator = "定位点", remove = '清除';
    ...
    function RouteLocator() {
        ...
        var routeLocatorParameters_point = new SuperMap.REST.RouteLocatorParameters({
            ...
            "type":"POINT",
            "measure":parseFloat($('#locateMeasure').val()),
            "offset":0,
            "isIgnoreGap":true
        });
