//type  F0根节点  F001响应级别  F01组织机构    F012具体组织
//type  F0根节点  F001响应级别  F02任务安排    F023处置项目  F0234任务安排
//type  F0根节点  F001响应级别  F03资源调度    F034具体资源
//type  F0根节点  F001响应级别  F04响应配置 
...
function post4Data(clickNodeId){ 
    $.post(eve.contextPath + '/jf/planmodel/getOrginations', {
     	...
     	json.children[0].children[0].children.push(newOrganitionNode);
     	json.children[1].children[0].children.push(newOrganitionNode);
     	json.children[2].children[0].children.push(newOrganitionNode);
     	json.children[3].children[0].children.push(newOrganitionNode);
     	}
     	//填充处置项目
     	for( var y=0;y<result.json1.length;y++){
          ...
          json.children[0].children[1].children.push(newDisProjectNode); 
          json.children[1].children[1].children.push(newDisProjectNode); 
          json.children[2].children[1].children.push(newDisProjectNode); 
          json.children[3].children[1].children.push(newDisProjectNode); 
        ...
        for( var i=0;i<result.json2.length;i++){
          ...
          json.children[0].children[2].children.push(newResourceNode); 
          json.children[1].children[2].children.push(newResourceNode);
          json.children[2].children[2].children.push(newResourceNode);
          json.children[3].children[2].children.push(newResourceNode);
...
function setTimeRefresh(){
	console.log(2*iii++);
	if(json.children[0].children[0].children.length>0){
		json.children[0].children[0].children.shift();
		console.log("aaaaa");
	} 
	json.children[0].children[0].children[1].data.type="F034";
	json.children[0].children[0].children[0].data.type="F012";
	var newOrganitionNode1={
 	        id : "aasdas"+iii,
            name : "组织机构"+iii,  
            data : {
            	type :"F012"
	...
	json.children[0].children[0].children.push(newOrganitionNode1);
	st.loadJSON(json);
	st.compute();
	st.refresh();
	};
...
//								    		reloadData("node001");
	...
	//定时器
	setInterval("setTimeRefresh();",15000);
}
